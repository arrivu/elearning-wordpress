    ...
    function show_form( $user_id = null ) {
        ...
        <div class="wpuf-profile">
            <form name="profile" id="your-profile" action="" method="post">
                ...
                <h1 class="about_compelling" style="text-align: left; color: #d03423;">Edit Profile</h1>
                                  
                    <table class="checkout" border="0" style="border:0px solid black;">
                        <tr>
                            <td><label for="user_login1"><?php _e( 'Username' ); ?></label></td>
                        ...
                        <tr>
                            <td><label for="first_name"><?php _e( 'First Name' ) ?></label></td>
                        ...
                        <tr>
                            <td><label for="nickname"><?php _e( 'Nickname' ); ?> <span class="description"><?php _e( '(required)' ); ?></span></label></td>
                            <td><input type="text" name="nickname" id="nickname" value="<?php echo esc_attr( $profileuser->nickname ) ?>" class="regular-text" /></td>
                        </tr>

                        <tr>
                            <td><label for="display_name"><?php _e( 'Display to Public as' ) ?></label></td>
                            <td>
                        ...
                        <?php /* ?>
                        <tr>
                            <td><label for="url"><?php _e( 'Website' ) ?></label></td>
                        ...
                        <tr>
                            <td><label for="description"><?php _e( 'Biographical Info', 'wpuf' ); ?></label></td>
                            <td><textarea name="description" id="description" rows="5" cols="30"><?php echo esc_html( $profileuser->description ); ?></textarea><br />
                                <span class="description"><?php _e( 'Share a little biographical information to fill out your profile. This may be shown publicly.' ); ?></span></td>
                        </tr>
                        <?php */?>
                        <tr id="password">
                            <td><label for="pass1"><?php _e( 'New Password', 'wpuf' ); ?></label></td>
                            <td>
                                <input type="password" name="pass1" id="pass1" size="16" value="" autocomplete="off" /><br /><br />
                            </td>
                        </tr>
                        <tr>
                            <td><label><?php _e( 'Confirm Password', 'wpuf' ); ?></label></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td><label><?php _e( 'Password Strength', 'wpuf' ); ?></label></td>
                            <td>
    ...
    function post_lock_form( $profileuser ) {
        ...
        if ( is_admin() && current_user_can( 'edit_users' ) ) {
            ...
            <table class="form-table">
                <tr>
                    <td><label for="post-lock"><?php _e( 'Lock Post:', 'wpuf' ); ?> </label></td>
                    <td>
                ...
                <tr>
                    <td><label for="post-lock"><?php _e( 'Lock Reason:', 'wpuf' ); ?> </label></td>
                    <td>
