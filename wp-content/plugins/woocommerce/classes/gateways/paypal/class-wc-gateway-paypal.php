	...
	function get_paypal_args( $order ) {
		...
		$paypal_args = array_merge(
			array(
				'cmd' 					=> '_cart',
				//'business' 				=> $this->email,
				'business' 				=> 'resmi.ramalingam@gmail.com',
				'no_note' 				=> 1,
...
//echo $paypal_adr;
		return '<form action="'.esc_url( 'https://www.sandbox.paypal.com/cgi-bin/webscr' ).'" method="post" id="paypal_payment_form" target="_top">
