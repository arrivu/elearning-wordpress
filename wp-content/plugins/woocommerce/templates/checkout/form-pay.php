			...
			<?php
				if ( $available_gateways = $woocommerce->payment_gateways->get_available_payment_gateways() ) {
					...
					<?php /* ?>
							...
							<input type="radio" id="payment_method" class="input-radio" name="payment_method" value="1" />
							<label for="payment_method_mijireh_checkout">Credit Card </label>
													
												
							<input type="radio" id="payment_method" class="input-radio" name="payment_method" value="2"  />
