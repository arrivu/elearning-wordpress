...
<?php /* ?>
	...
	<table class="shop_table my_account_orders">
		...
		<thead>
			<tr>
				<th class="order-number"><span class="nobr"><?php _e( 'Course', 'woocommerce' ); ?></span></th>
				...
				?><tr class="order">
					<td class="order-number">
						<a href="<?php echo esc_url( add_query_arg('order', $order->id, get_permalink( woocommerce_get_page_id( 'view_order' ) ) ) ); ?>">
							...
							echo get_post_meta( $order->id, '_purchase_note', true);	
							 ?>
						</a>
					</td>
					<td class="order-date">
...
<?php else:
//echo "You are not currently enrolled on any courses - check out <a>our selection of courses</a> and enroll today!";
?>
You are not currently enrolled on any courses - check out <a href="<?php echo $direct."/programmes"; ?>" style="color: #d03423;text-decoration: none;" >our selection of courses</a> and enroll today!
</h2>
</div>
<?php endif; ?>
