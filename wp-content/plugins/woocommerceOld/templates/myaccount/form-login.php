...
<script type="text/javascript">
  ...
  jQuery(document).ready(function(){
    (function($) {
      ...
      if(!window.fb_added){
        socialLogins.prepend('<a href=\"http://wordpress.com/rails/wp-login.php?loginFacebook=1\" rel=\"nofollow\"><div class=\"new-fb-btn new-fb-1 new-fb-default-anim\"><div class=\"new-fb-1-1\"><div class=\"new-fb-1-1-1\">CONNECT WITH</div></div></div></a><br />');
