...
<?php if ( !is_multisite() ) { ?>
	...
	<td><textarea name="description" id="description" rows="5" cols="30"><?php echo esc_attr($new_user_description); ?></textarea><br />
	<span class="description"><?php _e('Share a little biographical information to fill out your profile. This may be shown publicly.'); ?></span></td>
	 
</tr>
<?php /*?>
<tr>
        <th><label for="description"><?php _e('Instructor Image'); ?></label></th>
        <td>
        ...
        <p id="wpua-upload-messages">
          <span id="wpua-max-upload">Maximum upload file size: 2048KB.</span>
          <span id="wpua-allowed-files">Allowed Files: <code>jpg jpeg png gif</code></span>
        </p>
    </tr>   
    <?php */ ?>
