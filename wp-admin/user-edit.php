...
<img src="<?php echo get_site_url(); ?>/wp-content/themes/thecompellingimage/source/images/logo.png"  alt="img_photo1" />
</a>
<?php
$title = IS_PROFILE_PAGE ? __('Edit Profile') : __('Edit User');
...
<?php if ( rich_edit_exists() && !( IS_PROFILE_PAGE && !$user_can_edit ) ) :?>
	<tr>
